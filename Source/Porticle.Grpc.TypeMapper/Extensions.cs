...
public static class Extensions
{
    ...
    {
        return property.AccessorList.CheckNotNull("Accessors not found").Accessors.FirstOrDefault(a => a.IsKind(SyntaxKind.GetAccessorDeclaration))
            .CheckNotNull("Getter not found");
    }

    public static AccessorDeclarationSyntax GetSetter(this PropertyDeclarationSyntax property)
    {
        return property.AccessorList.CheckNotNull("Accessors not found").Accessors.FirstOrDefault(a => a.IsKind(SyntaxKind.SetAccessorDeclaration))
            .CheckNotNull("Setter not found");
    }
}